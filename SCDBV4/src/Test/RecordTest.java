...
public class RecordTest {
	...
	public void testSearchByKey() {
		List<Controller> result = Controller.searchByKey("leap","recording"); // also tested with different cases, still works
		assertEquals(2, result.size());
		
		List<Controller> result2 = Record.searchByKey("hum","recording");
